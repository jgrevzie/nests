...
Procedure.create(:name => "Structaul Heart - Patent Foramen Ovale", :abbrev => "PFO", :options => "")
Procedure.create(:name => "Structaul Heart - Patent Ductus Arteriosus", :abbrev => "PDA", :options => "")
Procedure.create(:name => "Structaul Heart - Atrial Septal Defect", :abbrev => "ASD", :options => "")
Procedure.create(:name => "Structaul Heart - Left Atrial Appendage", :abbrev => "LAA", :options => "")
...
Nurse.create(first_name: "Sheila", last_name: "Thompson", username: "sheila", password: 'password', validator: "true", email: "sheila.thompson@svpm.org.au")
Nurse.create(first_name: "Heather", last_name: "Macfarlane", username: "heather", password: 'password', validator: "true", email: "heather.macfarlane@svpm.org.au")
