Procedure.create(:name => "Coronary Angiography", :abbrev => "C/A", :options => "Inject?")
Procedure.create(:name => "Percutaneious Coronary Intervention", :abbrev => "PCI", :options => "")
Procedure.create(:name => "C/A + PCI", :abbrev => "", :options => "lego space, alpha team, mars mission,  power miners")
...
Procedure.create(:name => "Pericardialcenteses", :abbrev => "", :options => "Scrubbed?")
